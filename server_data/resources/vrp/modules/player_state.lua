...
AddEventHandler("vRP:playerSpawn",function(user_id,source,first_spawn)
	...
	if first_spawn then
		...
		vRPclient._setHandcuffed(source,false)
 	    ...
 	    if vRP.hasPermission(user_id,"mochila.permissao") then
		
		else
            local sets = {}
		
		    sets[1] = vRP.getInventoryItemAmount(user_id,"vale")
		    sets[2] = vRP.getInventoryItemAmount(user_id,"dias")
		    sets[3] = vRP.getInventoryItemAmount(user_id,"horas")
		    sets[4] = vRP.getInventoryItemAmount(user_id,"minutos")
		
		    vRP.clearInventory(user_id)
		
		    vRP.giveInventoryItem(user_id,"vale", sets[1])
		    vRP.giveInventoryItem(user_id,"dias", sets[2])
		    vRP.giveInventoryItem(user_id,"horas", sets[3])
		    vRP.giveInventoryItem(user_id,"minutos", sets[4])
		end

...
function checkPermission(id)
    if id >= 1000 then
        if parseInt(id) == 1009 and vRPEX.checkPermission("paramedico.permissao","Paramedico") then
            return true
        end
        if parseInt(id) == 1011 and vRPEX.checkPermission("radiopolicia.permissao","Policia") then
            return true
        end
    else
        return true

...
function IsPlayerInPolmav()
	...
	return IsVehicleModel(vehicle,GetHashKey("paramedicoheli")) or IsVehicleModel(vehicle,GetHashKey("policiaheli")) or IsVehicleModel(vehicle,GetHashKey("rotaheli"))
end

...
-----------------------------------------------------------------------------------------------------------------------------------------
src = {}
Tunnel.bindInterface("eag_garages",src)
vCLIENT = Tunnel.getInterface("eag_garages")
...
local garages = {
	...
	[18] = { ['name'] = "PoliciaShe", ['payment'] = false, ['perm'] = "policia.permissao" },
	...
	[36] = { ['name'] = "Salvador", ['payment'] = false, ['perm'] = "livre" },
	...
	[60] = { ['name'] = "Desmanche", ['payment'] = true, ['perm'] = "flanela.permissao" },
	[61] = { ['name'] = "Inicial", ['payment'] = false, ['perm'] = "livre" },
	[62] = { ['name'] = "Blood", ['payment'] = true, ['perm'] = "blood.permissao" },
	[63] = { ['name'] = "Hells", ['payment'] = true, ['perm'] = "flanela.permissao" },
	[64] = { ['name'] = "Garagem", ['payment'] = false, ['public'] = true },
	[65] = { ['name'] = "Motoclub", ['payment'] = true, ['perm'] = "motoclub.permissao" },
	[66] = { ['name'] = "Garagem", ['payment'] = false, ['perm'] = "vanilla.permissao" },
-----------------------------------------------------------------------------------------------------------------------------------------
---------------------------------------------------------FORTHILLS-----------------------------------------------------------------------
-----------------------------------------------------------------------------------------------------------------------------------------
...
-----------------------------------------------------------------------------------------------------------------------------------------
	...
	[612] = { ['name'] = "JACK", ['payment'] = false, ['public'] = false },
	[613] = { ['name'] = "LEANDRIN", ['payment'] = false, ['public'] = false },
	[614] = { ['name'] = "DIGGUERA", ['payment'] = false, ['public'] = false },
	[615] = { ['name'] = "BUENO", ['payment'] = false, ['public'] = false },
	[616] = { ['name'] = "Bennys", ['payment'] = false, ['public'] = true },
	[617] = { ['name'] = "SportRace", ['payment'] = true, ['perm'] = "mecanico.permissao" },
	[618] = { ['name'] = "TKF", ['payment'] = false, ['public'] = true },
	[619] = { ['name'] = "BennysServico", ['payment'] = true, ['perm'] = "mecanico.permissao" },
	[620] = { ['name'] = "GaragemViatura", ['payment'] = true, ['perm'] = "policia.permissao" },
	[621] = { ['name'] = "GaragemHeli", ['payment'] = true, ['perm'] = "policia.permissao" },
	[622] = { ['name'] = "PORTUGA", ['payment'] = false, ['public'] = false },
	[623] = { ['name'] = "TROPA", ['payment'] = false, ['public'] = true },
	[624] = { ['name'] = "Bloods", ['payment'] = false, ['public'] = true },
	--[625] = { ['name'] = "Fazendeiro", ['payment'] = true, ['perm'] = "fazendeiro.permissao" },
...
RegisterCommand('dv',function(source,args,rawCommand)
	local user_id = vRP.getUserId(source)
	if vRP.hasPermission(user_id,"owner.permissao") or vRP.hasPermission(user_id,"mod.permissao") or vRP.hasPermission(user_id,"admin.permissao") then
...
function src.vehicleLock()
	...
	if user_id then
		local vehicle,vnetid,placa,vname,lock,banned = vRPclient.vehList(source,7)
		if vehicle and placa then
			-- local myResult = vRP.query("creative/get_caruser",{ user_id = parseInt(user_id), vehicle = tostring(vehicle) })
			-- if user_id == myResult then

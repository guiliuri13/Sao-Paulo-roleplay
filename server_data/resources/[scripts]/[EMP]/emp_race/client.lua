					...
					if distance <= 5.9 then
						...
						if IsControlJustPressed(0,38) then
							...
							if explosive >= 70 then
								...
								TriggerEvent("Notify","importante","Você começou uma corrida <b>Explosiva</b>, não saia do veículo e termine<br>no tempo estimado, ou então seu veículo vai explodir com você dentro.")
							end
						end
					end
				end

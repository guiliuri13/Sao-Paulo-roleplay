...
local CoordenadaX = 895.23565673828
local CoordenadaY = -179.12297058106
...
Citizen.CreateThread(function()
	while true do
	    Citizen.Wait(1)
		local doninicio = GetDistanceBetweenCoords(GetEntityCoords(PlayerPedId()),895.23565673828,-179.12297058106,74.70, true)
		if doninicio < 4.0  then
		    dDrawText3Ds(895.23565673828,-179.12297058106,74.70, "[H] PARA INICIAR <b>EMPREGO</b>")
			DrawMarker(20,895.23565673828,-179.12297058106,74.70,0,0,0,0,180.0,130.0,0.5,0.5,0.5,25,255,25,55,0,0,0,0)
		    if IsControlJustPressed(0,74) then
			    emservico = true
				selecionado = math.random(1,20)
				CriandoBlip(locs,selecionado)
				TriggerEvent('chatMessage',"Chamou",{255,70,50},"Chamou aqui pra nois")
		    end
		end
	end
end)
...
function dDrawText3Ds(x,y,z, text)

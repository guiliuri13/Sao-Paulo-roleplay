...
window.onload = function () {
		...
		var eventCallback = {
			ui: function(data) {
				...
				else if (config.showServerLogo == false) { document.querySelector('.info.player').style.bottom = '61px'; }
				...
				else if (config.showVoice == false) { document.querySelector('.info.time-and-place').style.right = '29px'; }
